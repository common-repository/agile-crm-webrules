(function() {
    tinymce.PluginManager.add('agilecrm_webrules_button', function( editor, url ) {
        editor.addButton( 'agilecrm_webrules_button', {
            text: 'Agile Forms',
            icon: false,
            onclick: function() {
            jQuery.ajax({
                ...
                editor.windowManager.open( {
                    ...
                    onsubmit: function( e ) {
                        editor.insertContent( '[agileform_webrules id="' + e.data.form+ '"]');
                    }
                });
                }
            });
